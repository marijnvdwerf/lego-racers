...
def get_n64_config(region: str) -> SplatConfig:
    ...
    segment.add_segment(0x8630, "asm", "main/070")
    segment.add_segment(0x8D04, "garbage")
    segment.add_segment(0x8D10, "asm", "main/080a")  # needs split
    ...
    segment.add_segment(0x33800, "rdata", "stage2/105")
    ...
    segment.add_segment(0x36BC0, "rdata", "stage2/615")
    ...
    segment.add_segment(0x3CD70, "asm", "stage2/070")
    ...
    segment.add_segment(0x3E210, "cpp", "stage2/100")
    segment.add_segment(0x3E530, "asm", "stage2/105")
    ...
    segment.add_segment(0x43270, "cpp", "stage2/140")
    ...
    segment.add_segment(0x57730, "asm", "stage2/330")
    ...
    segment.add_segment(0x605C0, "cpp", "stage2/450")
    ...
    segment.add_segment(0x62910, "cpp", "stage2/480")
    ...
    segment.add_segment(0x6F510, "asm", "stage2/600")
    segment.add_segment(0x6FD2C, "garbage")
    segment.add_segment(0x6FD30, "asm", "stage2/610")
    segment.add_segment(0x702A0, "asm", "stage2/615")
    segment.add_segment(0x705CC, "garbage")
    segment.add_segment(0x705D0, "asm", "stage2/620")
    segment.add_segment(0x70BC0, "asm", "stage2/625")
    ...
    segment.add_segment(0x716B0, "asm", "stage2/650")
    ...
    segment.add_segment(0x735B0, "cpp", "stage2/680")
    segment.add_segment(0x74754, "garbage")
    segment.add_segment(0x74760, "cpp", "stage2/690")
    ...
    segment.add_segment(0x79B70, "data", "stage2/105")
